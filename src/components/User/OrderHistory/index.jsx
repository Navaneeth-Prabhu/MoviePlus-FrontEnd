...
function Order() {
  ...
  useEffect(() => {
    async function getHistroy() {
      ...
      const { data } = await UserInstance.get(`/history/${userEmail}`);
    ...
    <>
      {history.length ? (
            ...
            <div className="ticket3 flex h-full px-24 py-5">
              <div className="firsthalf flex">
                ...
                <div className="details  px-10">
                  <div className="text-xl ">{item?.movieId?.title}</div>
                  {/* <p>EVM ,Cherthala</p> */}
        ...
        <div className="flex flex-col justify-center items-center w-full">
          <p className="text-white underline text-3xl mt-36">Your order is empty </p>
          <img
            src="https://cdn.dribbble.com/users/1168645/screenshots/3152485/no-orders_2x.png"
            alt=""
          />
        </div>
      )}
